...
const string strMessageMagic = "WaspCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight <= 50)
	nSubsidy = 1000 * COIN; // first 50 blocks are 2000 coin reward
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in WaspCoin
    bool fStrictPayToScriptHash = true; // Always active in WaspCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WaspCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Wapscoin 01/07/14 - Blockchain Launches";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x35fe494fe314488ff67b773853efb4101e8077ebe8733375b83903cf71823a6c"));
